---
description: Initialize hooks-based tracking with LLM-enhanced summaries (v2.1). Creates claude_usage/ directory, tracking files, and enables Stop hook for real-time tracking.
---
